        ...
        <div className="w-full absolute top-0">
            {
                ...
                <button className="absolute left-[-10%] flex items-center justify-center p-1 bg-indigo-400 rounded-full" type="button" onClick={slideToPrev}>
                    <FaChevronLeft />
                </button>
            }
            {
                showSliderButton.nextBtn &&
                <button className="absolute right-[-10%] flex items-center justify-center p-1 bg-indigo-400 rounded-full" type="button" onClick={slideToNext}>
                    <FaChevronRight />
                </button>
            }
        </div>
